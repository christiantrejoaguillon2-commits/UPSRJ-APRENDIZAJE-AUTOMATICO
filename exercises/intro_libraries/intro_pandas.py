...
career_group = csv_df.groupby('carrera')['promedio'].mean()  # Series con promedios por carrera
general_mean = career_group.mean()  # Promedio general de los promedios por carrera
