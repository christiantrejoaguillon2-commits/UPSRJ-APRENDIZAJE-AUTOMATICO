...
career_group = csv_df.groupby("carrera")["promedio"].mean()  # Debe ser Series, no comparar con GroupBy
...
total_female = csv_df[csv_df["genero"] == "F"].shape[0]  # Debe contar F, no M otra vez
